...
class Agent:
    ...
    def remember(self, state, action, reward, state_, log_p, done):
        """
    ...
    def choose_action(self, observation):
        ...
        action_distribution = self.dsac.policy.get_act_dist(logits)
    ...
    def save_checkpoint(self, epoch: int, path: str, tar_name: str, txt_name: str):
        ...
        # Save
        agent_meta_data = (self.t_max, self.tau, self.static_alpha, self.reward_scale, self.gamma, self.update_interval,
                           self.auto_alpha)
    ...
    def load_checkpoint(self, path, tar_name: str, txt_name: str):
        ...
        t_max, tau, static_alpha, reward_scale, gamma, update_interval, auto_alpha = data['agent_params']
        ...
        self.__init__(obs_dim=state_dim, action_dim=action_dim, cr_lr_ini=cr_lr_ini, cr_lr_fin=cr_lr_fin,
                      ...
                      cr_hl=cr_hl, cr_activ=cr_activation, act_min_log_std=-100, # act_min_log_std=act_min_log_std,
                      act_max_log_std=act_max_log_std, act_hl=act_hl, act_activ=act_activation,
                      action_low=action_low, action_up=action_high, t_max=t_max, tau=tau,

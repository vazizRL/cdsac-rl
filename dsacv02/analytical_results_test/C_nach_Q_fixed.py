...
def partial_c_partial_q(mu_curr, std_curr, pdf_tar, supports, lr, cramer_supp, nabla=1, dev='cpu'):
    ...
    frac = b/c
    print(f'b is {b}')
    print(f'Fraction is {frac} \n')
    return - (1/std_curr) * frac * lr * nabla
...
if __name__ == '__main__':
    ...
    for std_i_curr in std_range:
        dCdQ = partial_c_partial_q(mu_curr=mu_curr_fixed, std_curr=std_i_curr, pdf_tar=distr_tar, supports=supp_var_std,

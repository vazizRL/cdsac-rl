...
class MixtureSameFamilyMod(Distribution):
    r"""
    ...
    Examples::
        ...
        >>> gmm = MixtureSameFamilyMod(mix, comp)
    ...
    def __init__(self,
        ...
        super(MixtureSameFamilyMod, self).__init__(batch_shape=cdbs,
    ...
    def expand(self, batch_shape, _instance=None):
        ...
        new = self._get_checked_instance(MixtureSameFamilyMod, _instance)
        ...
        super(MixtureSameFamilyMod, new).__init__(batch_shape=batch_shape,
                                                  event_shape=event_shape,
                                                  validate_args=False)
...
class ReparameterizedMixtureSameFamilyMod(MixtureSameFamilyMod):
    """

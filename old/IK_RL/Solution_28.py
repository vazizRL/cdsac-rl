...
class PandaRobotEnv_(gym.Env):
    ...
    def __init__(self,
        ...
        # Debugging
        self._action_low = np.array([-5])   # old: [-15,-15,-15]
        self._action_high = np.array([5])  # old: [15, 15, 15]
    ...
    def reset(self):
        ...
        self._step_size = 10 / ((self._delta_x_points + 1) * (self._delta_y_points + 1) *
                               (self._delta_z_points + 1))                  # old: no number_of_points

        # debug_step_size = 0.0008
        # for i in range(int(-5/debug_step_size), int(5/debug_step_size)):
        #     i = i * debug_step_size

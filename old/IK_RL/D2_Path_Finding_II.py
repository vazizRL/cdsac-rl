...
class PandaRobotEnv_(gym.Env):
    ...
    def reset(self):
        ...
        p.loadURDF("C:/Users/XMG/Desktop/Master/Masterarbeit/Custom_Objects/Obstacle/obstacle.obj.urdf",
    ...
    def getExtendedObservation(self):
        ...
        observation = []
        observation.extend(self._EE_orn)  # Cartesian position of goal
    ...
    def step(self, action):
        ...
        while self._EE_to_IK > 0.01 or abs(self._EE_orn[1] - action[3]) > 0.01:
            ...
            if self._renders:
                time.sleep(0.01)  # old value 0.35
...
#         actions = [0.7424035,  -0.0812215,  0.62876195, 1.4212569]
#     elif action_nr == 4:
#         actions = [0.5, -0.1, 0.7, -math.pi/2]
#     elif action_nr == 5:
#         actions = [0.4, -0.3, 0.7, -math.pi/2]
#     elif action_nr == 6:
#         actions = [0.5, -0.4, 0.6, -math.pi / 2]
#
#     else:

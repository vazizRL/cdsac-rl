...
from stable_baselines3.common.noise import NormalActionNoise, OrnsteinUhlenbeckNoise
...
if __name__ == '__main__':
    ...
    if loading:
        ...
        model = TD3(PATH_TO_MODEL,
                         ...
                         target_noise_clip=0.5,
                         tensorboard_log=TENSORBOARD_LOCATION,
                         policy_kwargs=dict(act_fun=params['act_fun'],

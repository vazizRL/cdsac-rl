...
class PandaRobotEnv_(gym.Env):
    ...
    def step(self, action):
        ...
        while self._EE_to_IK > self._residual_threshold:
            ...
            self._p.setJointMotorControlArray(bodyUniqueId=self._robot,
                                              ...
                                              forces=[150] * len(self._joint_indices_control))  # old 150
    ...
    def _reward(self):
        ...
        # Normalize distance reward. 2.05 is max. distance punishment
        reward /= 2.05
        ...
        if self._contact_with_env:
            ...
            reward -= (self._max_IK_points - self._previously_crashless)
...
#     liste_reward = liste_reward[-50:]
#     debug_step_counter += 1
#     print('Step: {}, Average reward is: {}'.format(debug_step_counter, np.array(liste_reward).mean()))
#     #
#     if done:
#         environment.reset()
#         action_nr = 0

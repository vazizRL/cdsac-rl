...
class PandaRobotEnv_(gym.Env):
    ...
    def retrieve_average_reward(self):

        average_reward = math.sum(self._reward_buffer)/len(self._reward_buffer)

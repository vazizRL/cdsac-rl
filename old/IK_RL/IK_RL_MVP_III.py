...
class PandaRobotEnv_(gym.Env):
    ...
    def __init__(self,
        ...
        self._residual_threshold = 0.003  # old: 0.003
        ...
        self.action_space = spaces.Box(np.array([-5]), np.array([5]))
    ...
    def step(self, action):
        ...
        while self._EE_to_IK > self._residual_threshold:
            ...
            self._p.setJointMotorControlArray(bodyUniqueId=self._robot,
                                              ...
                                              forces=[150] * len(self._joint_indices_control))
...
#         actions = [environment._goal_pos[0],environment._goal_pos[1] , 0.9]

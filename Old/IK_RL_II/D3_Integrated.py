...
class PandaRobotEnv_(gym.Env):
    ...
    def __init__(self,
        ...
        self._max_IK_points = 9        # Trained with 9
        ...
        self._robo_path = 'C:/Users/XMG/anaconda3/envs/CognitiveRobotics_Robo_Control-master/' \
                          'Lib/site-packages/pybullet_data/franka_panda/panda.urdf'
    ...
    def step(self, action):
        ...
        # self.take_image(camera_target_pos=(0.4, 0.3, 0.65), distance_cam=1.4,
        #                 yaw_pitch_roll=(90, -50, 0), up_axis=2, res=(500, 500))
    ...
    def _reward(self):
        ...
        if self._contact_with_env and not self._boundary_selected:
            ...
            reward = (-0.95 + (self._previously_crashless*0.08))
...
#     elif action_nr == 3:
#         actions = [environment._goal_pos[0], environment._goal_pos[1], environment._goal_pos[2] + 0.2]
#     elif action_nr == 4:
#         actions = [environment._goal_pos[0], environment._goal_pos[1], environment._goal_pos[2] + 0.2]
#     elif action_nr == 5:
#         actions = [environment._goal_pos[0], environment._goal_pos[1] - 0.2, environment._goal_pos[2]]
#     elif action_nr == 6:
#         actions = [environment._goal_pos[0], environment._goal_pos[1]-0.2, environment._goal_pos[2]]
#     elif action_nr == 7:
#         actions = [environment._goal_pos[0], environment._goal_pos[1] - 0.2, environment._goal_pos[2]]
...
#         actions = [environment._goal_pos[0], environment._goal_pos[1] - 0.2, environment._goal_pos[2]]
#     elif action_nr == 9:
#         actions = [environment._goal_pos[0] - 0.1, environment._goal_pos[1] - 0.1, environment._goal_pos[2]]
#     # elif action_nr == 10:
#     #     actions = [environment._goal_pos[0] - 0.1, environment._goal_pos[1], environment._goal_pos[2]]
#     else:

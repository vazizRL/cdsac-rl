...
class PandaRobotEnv_(gym.Env):
    ...
    def __init__(self,
        ...
        # self.action_space = spaces.Box(np.array([0.25, -0.4, 0.55]), np.array([1, 0.9, 1]))
        self.action_space = spaces.Box(np.array([0.25, -0.4, 0.55]), np.array([1., 0.9, 1.]))
    ...
    def step(self, action):
        ...
        while self._EE_to_IK > self._residual_threshold:
            ...
            if self._renders:
                time.sleep(0.10) #Old value 0.35
